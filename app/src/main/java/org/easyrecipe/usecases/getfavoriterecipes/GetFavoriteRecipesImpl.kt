...
class GetFavoriteRecipesImpl @Inject constructor(
    private val recipeRepository: RecipeRepository,
) : GetFavoriteRecipes {
    override suspend fun execute(request: GetFavoriteRecipes.Request) = runUseCase {
        val recipes = recipeRepository.getFavoriteRecipes()
        GetFavoriteRecipes.Response(recipes)
    }
}
