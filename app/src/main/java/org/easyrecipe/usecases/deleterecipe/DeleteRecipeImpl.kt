...
class DeleteRecipeImpl @Inject constructor(
    private val recipeRepository: RecipeRepository,
) : DeleteRecipe {
    override suspend fun execute(request: DeleteRecipe.Request) = runUseCase {
        recipeRepository.deleteRecipe(request.recipeId)
